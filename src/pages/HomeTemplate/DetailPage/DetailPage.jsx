            ...
            <div className='container'>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <img className='img-fluid' src='https://m.media-amazon.com/images/I/71UCZH3pUWL._SL1200_.jpg' alt='...' />
                    </div>
                    <div className="col-md-8">
                        <h2>IRON MAN 3</h2>
                        <p>Iron Man (tên thật là Tony Stark) là một siêu anh hùng hư cấu xuất hiện trong truyện tranh của Mỹ được xuất bản bởi Marvel Comics, cũng như các phương tiện truyền thông liên quan.</p>
                        <table class="table">

                            <tbody>
                                <tr>
                                    <td>Phân loại</td>
                                    <td>Phim dành cho khán giản trên 18 tuổi</td>
                                ...
                                <tr>
                                    <td><button className='btn btn-primary'>XEM TRAILER</button></td>
                                    <td><button className='btn btn-primary'>MUA VÉ NGAY</button></td>
                                </tr>
                ...
                <div className="row mt-5">
                    <div className="col-md-4">
                        <div className='d-flex align-items-center'>
                            ...
                            <h6 className="w-75">GALAXY CINEMA</h6>
                        </div>
                        <div className='d-flex align-items-center'>
                            <div className='p-2 w-25'>
                    ...
                    <div className="col-md-8">
                        ...
                        <div className='p-4'>
                            <div className='d-flex'>
                                ...
                                <div className='ml-2'>
                                    <h6>GLX-NGUYEN DU</h6>
                                    <address>115 Nguyen du, p.3, Quna phu nhuan<span>  Bản đồ</span></address>
                                </div>

                            </div>
                            <div className='d-flex'>
                                <span className=''>2D</span>
                                <div className='ml-2'>
                                    <span className='font-weight-bold text-success ml-2'>10:20 AM</span>
                                </div>
                            </div>
                            <div className='d-flex'>
                                <span className=''>3D</span>
                                <div className='ml-2'>
                                    <span className='font-weight-bold text-success ml-2'>90:20 AM</span>
                                    <span className='font-weight-bold text-success ml-2'>90:20 AM</span>
                                    <span className='font-weight-bold text-success ml-2'>90:20 AM</span>
