...
import Theater from '../HomePage/Theater';
...
class DetailPage extends Component {
    ...
    render() {
        const { filmClicked } = this.props
        const {theater} = this.state
        console.log(filmClicked.maPhim);
            ...
            (
                <>
                    ...
                    <div className='container'>
                        ...
                        <div>{console.log(filmClicked)}</div>
                        <div className="row">
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{filmClicked.ngayKhoiChieu}</td>
                                        </tr>
                                            ...
                                            <td>
                                                <a href={filmClicked.trailer}>
                                                    ...
                                                    <button
                                                        ...
                                                        className='btn btn-primary'>XEM TRAILER</button>
  ...
  <iframe class="embed-responsive-item" src={filmClicked.trailer} allowfullscreen></iframe>
</div> */}
